    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="text-center mb-20">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 font-heading">
          Welcome to <span className="text-anime-orange neon-glow">Aniflux</span>
        </h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
        <Card hover variant="gunmetal">
          <div className="text-center">
            <div className="text-5xl mb-6">🛍️</div>
            <h3 className="text-2xl font-semibold mb-3 text-white font-heading">Shop Products</h3>
        ...
        <Card hover variant="gunmetal">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-semibold mb-3 text-white font-heading">Read Blog</h3>
            <p className="text-gray-300 mb-6 leading-relaxed">
        ...
        <Card hover variant="gunmetal">
          <div className="text-center">
            <div className="text-5xl mb-6">✨</div>
            <h3 className="text-2xl font-semibold mb-3 text-white font-heading">Easy Shopping</h3>
            <p className="text-gray-300 mb-6 leading-relaxed">
      ...
      {/* CTA Section */}
      <section className="anime-gradient rounded-2xl p-12 md:p-16 text-center text-white shadow-lg">
